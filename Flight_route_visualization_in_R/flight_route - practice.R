...
setwd('F:\\2017-SOFTWARE-WORKSPACES\\FLIGHT-DATA-PROJECT')
rm(list = ls())
...
urb <- c(geom_polygon(aes(long, lat, group = group),
                    ...
                    alpha = 0.8,
                    data = urbanareasin))
####jpeg(filename="nehaprojectlatest.jpeg")
####tiff(filename = "nehaproject",res = 800, pointsize = 2)
png("flightdataproject.png", width = 2500, height = 1200)
